...
//     private readonly ILogger<MarkdownGenerator> _logger1 = LoggerFactory.Create(builder => builder.AddConsole()).CreateLogger<MarkdownGenerator>();
//     private readonly ILogger<OpenAIClientService> _logger2 = LoggerFactory.Create(builder => builder.AddConsole()).CreateLogger<OpenAIClientService>();
...
//             ApiKey = apiKey
//         };
//         _keyVaultService = new KeyVaultService(null, null);
//         _openAIClientService = new OpenAIClientService(config, _keyVaultService, _logger2);
//         _markdownGenerator = new MarkdownGenerator(_openAIClientService, _logger1);
//     }
...
//         _logger1.LogInformation("Markdown: {markdown}", markdown);
//     }
