...
public static class ValidationHelpers
{
    ...
    {
        public static readonly Regex SafeId = new(@"^[a-zA-Z0-9._@-]{1,50}$", RegexOptions.Compiled);
        ...
        public static readonly Regex SafeDomain = new(@"^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$", RegexOptions.Compiled);
