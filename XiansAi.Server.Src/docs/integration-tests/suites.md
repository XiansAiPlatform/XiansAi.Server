...
See [Temporal tests](./temporal.md). Classes: `AdminApiTemporalEndpointsTests`, `AdminApiTemporalLifecycleTests`, `AdminApiTemporalScheduleAndTaskTests`, `AdminApiTemporalEchoAgentLifecycleTests`, `AdminApiTemporalKnowledgeAgentLifecycleTests`, `AdminApiTemporalSecretVaultAgentLifecycleTests`, `AdminApiTemporalSecretVaultSdkAgentLifecycleTests`, `AdminApiTemporalDocumentDbAgentLifecycleTests`, `AdminApiTemporalDocumentDbSdkAgentLifecycleTests`, `AdminApiTemporalWebhookAgentLifecycleTests`, `AdminApiTemporalFileMessagingAgentLifecycleTests`, `AdminApiTemporalWorkflowFileMessagingAgentLifecycleTests`, `AdminApiTemporalCustomWorkflowAgentLifecycleTests`, `AdminApiTemporalWorkflowHandleAgentLifecycleTests`, `AdminApiTemporalScheduleAgentLifecycleTests`, `AdminApiTemporalScheduleSdkAgentLifecycleTests`, `AdminApiTemporalHitlTaskAgentLifecycleTests`, `AdminApiTemporalHitlTaskSdkAgentLifecycleTests`, `AdminApiTemporalHitlTaskConversationAgentLifecycleTests`, `AdminApiTemporalCrossAgentWorkflowLifecycleTests`, `AdminApiTemporalActivationSdkAgentLifecycleTests`, `AdminApiTemporalMetricsAgentLifecycleTests`, `AdminApiTemporalLoggingAgentLifecycleTests`, `AdminApiTemporalMessagingSdkAgentLifecycleTests`, `AdminApiTemporalTenantScopedAgentLifecycleTests`.

Lib-backed cycles (Echo chat/SSE, Knowledge overrides, Secret Vault strict scopes, Secret Vault SDK, Document DB, Document DB SDK, builtin Webhooks, file messaging, workflow file send, custom workflows, workflow handle, schedules, schedule SDK, HITL tasks, HITL SDK, HITL conversation, cross-agent workflows, activations SDK, metrics, logging, messaging SDK, tenant-scoped agents) are documented in [Lib agent workflows](./lib-agent-workflows.md).
