...
See [Temporal tests](./temporal.md). Classes: `AdminApiTemporalEndpointsTests`, `AdminApiTemporalLifecycleTests`, `AdminApiTemporalScheduleAndTaskTests`, `AdminApiTemporalEchoAgentLifecycleTests`, `AdminApiTemporalKnowledgeAgentLifecycleTests`, `AdminApiTemporalKnowledgeListAgentLifecycleTests`, `AdminApiTemporalKnowledgeSdkAgentLifecycleTests`, `AdminApiTemporalSecretVaultAgentLifecycleTests`, `AdminApiTemporalSecretVaultUserScopeAgentLifecycleTests`, `AdminApiTemporalSecretVaultSdkAgentLifecycleTests`, `AdminApiTemporalDocumentDbAgentLifecycleTests`, `AdminApiTemporalDocumentDbSdkAgentLifecycleTests`, `AdminApiTemporalDocumentDbContextAgentLifecycleTests`, `AdminApiTemporalWebhookAgentLifecycleTests`, `AdminApiTemporalWebhookSdkAgentLifecycleTests`, `AdminApiTemporalWebhookContextAgentLifecycleTests`, `AdminApiTemporalFileMessagingAgentLifecycleTests`, `AdminApiTemporalWorkflowFileMessagingAgentLifecycleTests`, `AdminApiTemporalCustomWorkflowAgentLifecycleTests`, `AdminApiTemporalChildWorkflowAgentLifecycleTests`, `AdminApiTemporalWorkflowHandleAgentLifecycleTests`, `AdminApiTemporalScheduleAgentLifecycleTests`, `AdminApiTemporalScheduleSdkAgentLifecycleTests`, `AdminApiTemporalScheduleCreateAgentLifecycleTests`, `AdminApiTemporalHitlTaskAgentLifecycleTests`, `AdminApiTemporalHitlTaskSdkAgentLifecycleTests`, `AdminApiTemporalHitlTaskConversationAgentLifecycleTests`, `AdminApiTemporalHitlLastTaskIdAgentLifecycleTests`, `AdminApiTemporalCrossAgentWorkflowLifecycleTests`, `AdminApiTemporalActivationSdkAgentLifecycleTests`, `AdminApiTemporalMetricsAgentLifecycleTests`, `AdminApiTemporalLoggingAgentLifecycleTests`, `AdminApiTemporalMessagingSdkAgentLifecycleTests`, `AdminApiTemporalTenantScopedAgentLifecycleTests`.

Lib-backed cycles (Echo chat/SSE, Knowledge overrides, Knowledge list, Knowledge SDK dual-context, Secret Vault strict scopes, Secret Vault user scope, Secret Vault SDK, Document DB, Document DB SDK, Document context dual-context, builtin Webhooks, Webhook SDK, Webhook context dual-context, file messaging, workflow file send, custom workflows, child workflows, workflow handle, schedules, schedule SDK, schedule create, HITL tasks, HITL SDK, HITL conversation, HITL last task, cross-agent workflows, activations SDK, metrics, logging, messaging SDK, tenant-scoped agents) are documented in [Lib agent workflows](./lib-agent-workflows.md).
