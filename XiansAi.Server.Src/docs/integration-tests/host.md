...
| Xians.Lib worker | Echo, Knowledge, Knowledge SDK, Secret Vault, Secret Vault SDK, Document DB, Document context, Webhooks, Webhook context, Files, Custom workflow, Child workflows, Schedules, Schedule SDK, HITL, HITL SDK, Cross-agent, Activations SDK, Metrics, Logging, and related Lib cycles | PFX-shaped key from [`XiansLibTestCertificate`](../../../XiansAi.Server.Tests/TestUtils/XiansLibTestCertificate.cs) over [`TestServerLoopback`](../../../XiansAi.Server.Tests/TestUtils/TestServerLoopback.cs), owned by [`LibAgentWorkflowHost`](../../../XiansAi.Server.Tests/TestUtils/LibAgentWorkflowHost.cs) |
