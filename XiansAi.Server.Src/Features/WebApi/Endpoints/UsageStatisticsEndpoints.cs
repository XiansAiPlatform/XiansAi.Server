...
public static class UsageStatisticsEndpoints
{
    public static void MapUsageStatisticsEndpoints(this WebApplication app)
    {
        ...
        group.MapGet("", async (
            ...
            [FromServices] IUsageStatisticsService usageStatisticsService,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var request = new UsageStatisticsRequest
        {
        ...
        var response = await usageStatisticsService.GetUsageStatisticsAsync(request, cancellationToken);
