    ...
    public class WebhookRepository : IWebhookRepository
    {
        ...
        public WebhookRepository(IDatabaseService databaseService)
        {
            ...
            _ = Task.Run(async () =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Console.WriteLine($"Warning: Background index creation failed during AgentApi WebhookRepository initialization: {ex.Message}");
                }
            });
        }
        ...
        private async Task InitializeIndexesAsync()
        {
            ...
            try
            {
                ...
                Console.WriteLine("Successfully created indexes for AgentApi Webhook collection");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"Warning: Failed to create indexes for AgentApi Webhook collection, but repository will continue to function: {ex.Message}");
            }
        }
