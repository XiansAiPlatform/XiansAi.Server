...
/// <summary>
/// AdminApi endpoints for submitting and querying feedback on agent messages.
///
/// These endpoints live under <c>/api/v{version}/admin/tenants/{tenantId}/feedback</c>. The tenant
/// is resolved authoritatively by the Admin API auth pipeline: a TenantAdmin is locked to their
/// own tenant, while a SysAdmin may target any existing tenant via the route.
/// </summary>
